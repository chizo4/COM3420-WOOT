...
set :repo_url,    'git@git.shefcompsci.org.uk:com3420-2022-23/team22/project.git'
set :linked_files,
...
set :whenever_variables, lambda {
  "\"environment=#{fetch(:whenever_environment)}&delayed_job_args_p=#{fetch(:delayed_job_identifier)}&delayed_job_args_n
    =#{fetch(:delayed_job_workers)}\""
}
